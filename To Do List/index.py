...
class TodoList(tk.Tk):
    def __init__(self):
        ...
        h,w=self.winfo_screenheight(),self.winfo_screenwidth()
        ...
        self.task_input.insert(0, "Enter your list here...")
        ...
        ttk.Button(self, text="Done", style="success.TButton",
                   command=self.done_task).pack(side=tk.LEFT, padx=10, pady=10)
    ...
    def clear_placeholder(self, event):
        if self.task_input.get() == "Enter your list  here...":
            self.task_input.delete(0, tk.END)
